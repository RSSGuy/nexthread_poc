...
import 'news_sources.dart'; // IMPORT ADDED
import 'dart:async';
...
class _AgentSimulationDialogState extends State<AgentSimulationDialog> {
  ...
  final List<Map<String, String>> _steps = [
    ...
    // FIXED: Dynamically calls the length instead of hardcoding '12'
    {"agent": "A", "msg": "Scanning ${NewsSources.targetSources.length} Whitelisted Agriculture Feeds..."},
...
// CHANGED: Added Row to hold Fallback Badge + Severity Badge
Row(
children: [
...
import 'models.dart'; // Ensure this file exists from previous step
import 'dart:async';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text("Divergence Glossary", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          ...SignalData.divergenceGlossary.map((section) {
            return Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
