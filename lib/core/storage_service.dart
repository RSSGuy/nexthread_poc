...
class StorageService {
  ...
  // Changed input type to Map<String, dynamic> to support structured data
  static Future<void> saveGlobalAnalysis(Map<String, dynamic> analysisMap) async {
    final box = Hive.box(_boxName);
    final data = {
      'content': analysisMap,
      'timestamp': DateTime.now().toIso8601String(),
    ...
    await box.put('global_analysis_snapshot', data);
    print("StorageService: Saved structured global analysis.");
  }
