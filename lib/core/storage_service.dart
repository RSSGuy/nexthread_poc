...
class StorageService {
  ...
  static const String _diagnosticsBoxName = 'diagnostics_v1'; // NEW
  ...
  static Future<void> init() async {
    ...
    await Hive.openBox(_diagnosticsBoxName); // NEW
  ...
  static Future<void> saveFeedHealthResults(List<FeedHealthResult> results) async {
    ...
    // We only save the "last_run", overwriting previous tests
    await box.put('last_run', data);
    print("StorageService: Saved ${results.length} feed health results.");
  }
...
class StorageService {
  ...
  // --- GLOBAL ANALYSIS PERSISTENCE (NEW) ---
  ...
  static Future<void> saveGlobalAnalysis(String analysis) async {
    ...
    await box.put('global_analysis', data);
    print("StorageService: Saved global market analysis.");
  }

  static Map<String, dynamic>? getGlobalAnalysis() {
    final box = Hive.box(_userBoxName);
    final dynamic rawData = box.get('global_analysis');
...
class StorageService {
  ...
  // --- NEW: GLOBAL ANALYSIS PERSISTENCE ---
