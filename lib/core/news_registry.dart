...
class NewsRegistry {
  ...
  static const reutersCommodities = NewsSourceConfig(
      ...
      url: "https://www.reutersagency.com/feed/?best-topics=commodities&post_type=best",
      type: "Global",
      // UPDATED: Added Agriculture, Mining, Manufacturing so it appears in those topics
      tags: [Naics.information, Naics.finance, Naics.agriculture, Naics.mining, Naics.manufacturing]
  );
  ...
  static const usdaGeneral = NewsSourceConfig(
      ...
      url: "https://www.usda.gov/rss/latest-releases.xml",
      type: "Government",
      tags: [Naics.publicAdmin, Naics.agriculture, Naics.manufacturing] // Manufacturing for food processing
  );
  ...
  static const usdaForestService = NewsSourceConfig(
      ...
      url: "https://www.fs.usda.gov/rss/news/releases",
      type: "Government",
      tags: [Naics.publicAdmin, Naics.agriculture] // Forestry is under Agriculture
  );
  ...
  static const epaNews = NewsSourceConfig(
      ...
      url: "https://www.epa.gov/newsreleases/search/rss",
      type: "Gov",
      tags: [Naics.publicAdmin, Naics.manufacturing, Naics.utilities]
  );
  ...
  static const foodBusinessNews = NewsSourceConfig(
      ...
      url: "https://www.foodbusinessnews.net/rss/articles",
      type: "Manufacturing",
      // UPDATED: Added Agriculture because it covers raw ingredients
      tags: [Naics.manufacturing, Naics.accommodation, Naics.agriculture]
  );
  ...
  static const biofuelsNews = NewsSourceConfig(
      ...
      url: "https://biofuels-news.com/feed/",
      type: "Energy",
      // UPDATED: Added Agriculture because it covers ethanol/corn
      tags: [Naics.manufacturing, Naics.utilities, Naics.agriculture]
  );
  ...
  static const lbmJournal = NewsSourceConfig(
      ...
      url: "https://lbmjournal.com/feed/",
      type: "Trade",
      tags: [Naics.wholesaleTrade, Naics.construction, Naics.agriculture] // Ag for Forestry connection
  );
  ...
  static const constructionDive = NewsSourceConfig(
      ...
      url: "https://www.constructiondive.com/feeds/news/",
      type: "Demand",
      tags: [Naics.construction, Naics.manufacturing, Naics.agriculture]
  );
  ...
  // --- MASTER LIST ---
  // This allows us to scan everything dynamically
  static List<NewsSourceConfig> get all => [
    reutersCommodities,
    usdaGeneral,
    usdaForestService,
    epaNews,
