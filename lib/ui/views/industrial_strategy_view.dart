      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // --- AI LOGIC BUTTON (Matches BriefingCard style) ---
            if (sector['ai_logic_references'] != null && sector['ai_logic_references'].toString().isNotEmpty) ...[
              const SizedBox(height: 16),
              const Divider(height: 1),
              const SizedBox(height: 16),
              InkWell(
                onTap: () => _showAiLogicModal(context, sector['ai_logic_references']),
                child: const Row(
                  children: [
